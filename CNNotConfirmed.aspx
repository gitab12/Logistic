<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CNNotConfirmed.aspx.cs" Inherits="CNNotConfirmed" %>
...
<body>
    ...
    <asp:SqlDataSource ID="ds_ProjectNo" runat="server" ConnectionString="<%$ ConnectionStrings:BizCon %>" SelectCommand="select distinct ProjectNo   from CollectionNote "></asp:SqlDataSource>
        ...
        <center><h2 class="title-one">Collectionnote Not Confirmed</h2></center>
...
<table><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ProjectNo :</td><td>&nbsp;WBSNo :</td></tr> 
       ...
       <td> <asp:DropDownList ID="ddl_WBSNo" runat="server"  AppendDataBoundItems="True">
        ...
        <asp:GridView ID="grd_Cnnotconfirmed" runat="server" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="Both">
            ...
            <EmptyDataTemplate >
                <asp:Label ID ="lbl_Msg" runat ="server" ForeColor ="Red" Font-Bold ="true" Text ="This collection note already confirmed"></asp:Label>
            </EmptyDataTemplate>
        </asp:GridView>
