<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="TripAcceptance.aspx.cs" Inherits="TripAcceptance" %>
...
<br />
    ...
    <br />
         ...
         <asp:Button ID="ButAcceptance" runat="server" Text="Confirm Acceptance" 
            onclick="ButAcceptance_Click" Class="btn btn-primary"/>
        </div>
    <br />
