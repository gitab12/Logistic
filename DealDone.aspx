<%@ Page Language="VB" MasterPageFile="~/MasterPage/AarmsMasterPage.master" AutoEventWireup="false" CodeFile="DealDone.aspx.vb" Inherits="DealDone" %>
...
&nbsp;<br />
    ...
    <div style="margin-left:450px">
        <asp:Button ID="ButCancel" runat="server" Text="CancelDeal"  class="btn btn-primary"/>
    </div>
      <br /><br /><br /><br /><br /><br />
