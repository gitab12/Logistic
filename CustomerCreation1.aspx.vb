...
Partial Class CustomerCreation
    ...
    Protected Sub Btn_submit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_submit.Click
        Dim res As Integer
        Session("ClientID") = 1
        res = Bizconnect.Insert_Customer(Session("ClientID"), Txt_companyname.Text, txt_noE.Text, Txt_YOE.Text, txt_Annualturnover.Text, txt_url.Text,DDLLocation.SelectedValue, Txt_address.Text, Txt_city.Text, Txt_state.Text, txt_pincode.Text, txt_Boardno.Text, Txt_fax.Text, txt_Email.Text, Txt_country.Text)
        If res = 1 Then
            lblmsg.Visible = True
    ...
    Protected Sub But_Addcustomer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles But_Addcustomer.Click
