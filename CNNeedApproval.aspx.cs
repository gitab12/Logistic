...
public partial class CNNeedApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     if (Session["UserID"] != string.Empty && Convert.ToInt32(Session["UserID"].ToString()) > 0)
        ...
        if (!IsPostBack)
        {
            ...
            ds_cn = obj_class.Get_CnNeedApproval(Session["pjtno"].ToString ());
            
            grd_CnneedApproval.DataSource = ds_cn;
            grd_CnneedApproval .DataBind();
        }
        }
        else
        {
    ...
    {
        ds_WBSNo = obj_class.Get_LoadWBSNoForCNNeedApproval(ddl_ProjectNo.SelectedValue.ToString());
     ...
     protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        {
            ds_CNote = obj_class.Bizconnect_ThermaxCNote_SearchByProjectNoAndWBSNo(ddl_ProjectNo.SelectedValue.ToString(), ddl_WBSNo.SelectedValue.ToString(), "CNNeedAproval");
            grd_CnneedApproval.DataSource = ds_CNote;
            grd_CnneedApproval.DataBind();
        }
        else
        {
            ds_CNote = obj_class.Bizconnect_ThermaxCNote_SearchByProjectNoAndWBSNo(ddl_ProjectNo.SelectedValue.ToString(), string.Empty, "CNNeedAproval");
            grd_CnneedApproval.DataSource = ds_CNote;
            grd_CnneedApproval.DataBind();
...
protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ExportGrid(grd_CnneedApproval, "Report.xls");
