...
public partial class VehiclePlanned : System.Web.UI.Page
{
    ...
    public void VehiclePlan()
    {
        ...
        ds = Obj_Class.Get_VehiclePlanned(Session["pjtno"].ToString ());
        grd_VehiclePlanned.DataSource = ds;
        grd_VehiclePlanned.DataBind();
       
    }
    
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ds_CNote = Obj_Class.Bizconnect_ThermaxVehPlacementSearchonPjtNo(ddl_ProjectNo.SelectedValue.ToString(),"VehPlanned");
            grd_VehiclePlanned.DataSource = ds_CNote;
            grd_VehiclePlanned.DataBind();
    }
     ...
     protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ExportGrid(grd_VehiclePlanned, "Report.xls");
