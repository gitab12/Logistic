<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectionNoteConfirmed.aspx.cs" Inherits="CollectionNoteConfirmed" %>
...
<body>
    ...
    <div>
        ...
        <center><h2  class="title-one">Collectionnote Confirmed</h2></center>
...
<table><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ProjectNo :</td><td>&nbsp;WBSNo :</td></tr> 
    ...
    <asp:GridView ID="grd_CollectNoteConfirmed" runat="server" 
