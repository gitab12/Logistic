...
Partial Class DealDone
    ...
    Sub gridbind()
        Try
            ...
            ds = obj_class.BiZconnect_DealDone()
    ...
    Protected Sub ButCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButCancel.Click
        ...
        For i As Integer = 0 To GridAssign.Rows.Count - 1
            ...
            If checkassign1.Checked Then
                ...
                resp = obj_class.Cancel_DealDone(replyid.Text, lblpostid.Text)
        ...
        Next
        If resp = 1 Then
            ClientScript.RegisterStartupScript(Me.GetType(), "clientscript", "alert ('Deal Cancel Successfully')", True)
        End If
        'Summary()
