<%@ WebHandler Language="C#" Class="RightImageHandler" %>
...
public class RightImageHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        obj_BizConn.Open();
        SqlCommand command = new SqlCommand("select imageRight FROM Bizconnect_PreloadDetails WHERE   AcceptanceID=" + ImageDestinationLocationID, obj_BizConn);
