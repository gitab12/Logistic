<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CNNeedApproval.aspx.cs" Inherits="CNNeedApproval" %>
...
<body>
    ...
    <asp:SqlDataSource ID="ds_ProjectNo" runat="server" ConnectionString="<%$ ConnectionStrings:BizCon %>" SelectCommand="select distinct ProjectNo   from CollectionNote "></asp:SqlDataSource>
        ...
        <center><h2 class="title-one">Collectionnote Need Approval</h2></center>
...
<table><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ProjectNo :</td><td>&nbsp;WBSNo :</td></tr> 
       ...
       <td> <asp:DropDownList ID="ddl_WBSNo" runat="server"  AppendDataBoundItems="True">
        ...
        <asp:GridView ID="grd_CnneedApproval" runat="server" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="Both">
            ...
            <SelectedRowStyle BackColor="#FFCC66" Font-Bold="True" ForeColor="Navy" />
             <EmptyDataTemplate >
                <asp:Label ID ="lbl_Msg" runat ="server" ForeColor ="Red" Font-Bold ="true" Text ="None of the collection notes went for approval under this project"></asp:Label>
            </EmptyDataTemplate>
