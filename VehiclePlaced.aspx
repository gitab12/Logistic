<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VehiclePlaced.aspx.cs" Inherits="VehiclePlaced" %>
...
<body>
    ...
    <asp:SqlDataSource ID="ds_ProjectNo" runat="server" ConnectionString="<%$ ConnectionStrings:BizCon %>" SelectCommand="select distinct ProjectNo   from CollectionNote "></asp:SqlDataSource>
        ...
        <center><h2 class="title-one">Vehicle Placed</h2></center>
    ...
    <asp:GridView ID="grd_VehiclePlaced" runat="server" 
