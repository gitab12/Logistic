<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Loadontime.aspx.cs" Inherits="Loadontime" %>
<!DOCTYPE html>
...
<body>
    ...
    <asp:SqlDataSource ID="ds_ProjectNo" runat="server" ConnectionString="<%$ ConnectionStrings:BizCon %>" SelectCommand="select distinct ProjectNo   from CollectionNote "></asp:SqlDataSource>
        ...
        <center><h2 class="title-one">Vehicle Loaded Ontime</h2></center>
    ...
    <asp:GridView ID="grd_VehLoadOntime" runat="server" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="Both">
