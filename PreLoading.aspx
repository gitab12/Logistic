<%@ Page  Language="C#" MasterPageFile="~/MasterPage/MasterPageDashboardMenu.master" AutoEventWireup="true" CodeFile="PreLoading.aspx.cs" Inherits="PreLoading"  %>
...
<ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="ImageButton1" TargetControlID="txtToDate">
            ...
            <td >
                <asp:Button ID="Button2" runat="server" Text="Download To Excel"  onclick="Button2_Click" class="btn btn-primary"  />
            </td>
        </tr>
    </table>
</div>
