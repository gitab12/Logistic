<%@ WebHandler Language="C#" Class="RearImageHandler" %>
...
public class RearImageHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        obj_BizConn.Open();
        SqlCommand command = new SqlCommand("select RearImage FROM Bizconnect_PreloadDetails WHERE   AcceptanceID=" + ImageDestinationLocationID, obj_BizConn);
