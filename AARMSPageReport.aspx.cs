...
public partial class AARMSPageReport : System.Web.UI.Page
{
    ...
    {
        DataSet ds_AarmsReport = new DataSet();
        ds_AarmsReport =obj_Class .AARMSPageReport ();
        grd_AarmsReport.DataSource = ds_AarmsReport;
        grd_AarmsReport.DataBind();
    }
     ...
     protected void Butexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        ExportGrid(grd_AarmsReport, "CollectionNoteReport.xls");
