...
public partial class CollectionNoteGenerated : System.Web.UI.Page
{
    ...
    public void CollecNoteGenerated()
    {
        ds.Clear();
        ...
        ds = Obj_Class.Get_CollectionNoteGeneated(Session["pjtno"].ToString ());
        Grd_CollectnoteGenerated.DataSource = ds;
        Grd_CollectnoteGenerated.DataBind();
        //lblcount.Text = "Count: "+Grd_CollectnoteGenerated.Rows.Count.ToString()+"";
    }
     protected void ddl_ProjectNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ds_WBSNo = Obj_Class.Bizconnect_ThermaxCnote_LoadWBSNoBasedOnProject(ddl_ProjectNo.SelectedValue.ToString());
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        {
            ds_CNote = Obj_Class.Bizconnect_ThermaxCNote_SearchByProjectNoAndWBSNo(ddl_ProjectNo.SelectedValue.ToString(), ddl_WBSNo.SelectedValue.ToString(), "CNoteGenerated");
            Grd_CollectnoteGenerated.DataSource = ds_CNote;
            Grd_CollectnoteGenerated.DataBind();
        }
        else
        {
            ds_CNote = Obj_Class.Bizconnect_ThermaxCNote_SearchByProjectNoAndWBSNo(ddl_ProjectNo.SelectedValue.ToString(), string.Empty, "CNoteGenerated");
            Grd_CollectnoteGenerated.DataSource = ds_CNote;
            Grd_CollectnoteGenerated.DataBind();
 ...
 protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ExportGrid(Grd_CollectnoteGenerated, "Report.xls");
