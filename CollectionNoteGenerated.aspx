<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectionNoteGenerated.aspx.cs" Inherits="CollectionNoteGenerated" %>
...
<body>
    ...
    <asp:SqlDataSource ID="ds_ProjectNo" runat="server" ConnectionString="<%$ ConnectionStrings:BizCon %>" SelectCommand="select distinct ProjectNo   from CollectionNote "></asp:SqlDataSource>
        ...
        <center><h2 class="title-one">Collectionnote Generated</h2></center>
    ...
    <asp:GridView ID="Grd_CollectnoteGenerated" runat="server" 
