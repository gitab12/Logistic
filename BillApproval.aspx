<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="BillApproval.aspx.cs" Inherits="BillApproval" %>
                                                    ...
                                                    <td align="left"  >
                                                        <table align="left" style="width: 100%;"  >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="style3">
                                                                    Increase Price (B)<br />
                                                                     <asp:TextBox ID="txtApprovedPRice" runat="server"  
                    ...
                    <asp:ListItem Value="2" Text="Discrepancy in Bill"></asp:ListItem>
                                                                ...
                                                                <td class="style4">
                                                                    ...
                                                                    <asp:Button ID="btn_Save" runat="server" Text="Save" OnClick="btn_Save_Click" />
                                                                           &nbsp;<asp:Button ID="btn_Approved" runat="server" Enabled ="true" Text="Approve" OnClick="btn_Approved_Click" />
                                                                        </td>
                                                                     <td class="style3">
