<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ImportExportMaster.master" AutoEventWireup="true" CodeFile="BuyerMaster.aspx.cs" Inherits="ImportExport_BuyerMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Panel ID ="pnl_Ordermanagement" GroupingText ="Buyer Master" CssClass="Panel" Width ="400px" runat ="server" >
        <table align="left" cellpadding ="5" cellspacing ="2">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Buyername" width="200px" onkeypress="return onlyalphawithspace(event)" cssclass="txtboxcss" runat="server"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="rfv_Buyername" runat="server" 
                       ControlToValidate="txt_Buyername" ErrorMessage="*" ></asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Contactperson" width="200px" cssclass="txtboxcss" onkeypress="return onlyalphawithspace(event)" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Contactno" onkeypress="return onlynumber(event)" width="200px" cssclass="txtboxcss" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Address"  width="200px" TextMode ="MultiLine" Height ="100px" cssclass="txtboxcss" runat="server"></asp:TextBox>
                </td>
            </tr>
