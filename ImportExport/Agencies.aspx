<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ImportExportMaster.master" AutoEventWireup="true" CodeFile="Agencies.aspx.cs" Inherits="ImportExport_Agencies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <br />
    <asp:Panel ID ="pnl_Ordermanagement" GroupingText ="Agency Master" CssClass="Panel" Width ="400px" runat ="server" >
        <table align="left" cellpadding ="5" cellspacing ="2">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Agencyname" width="200px" cssclass="txtboxcss" runat="server"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="rfv_Agencyname" runat="server" 
                       ControlToValidate="txt_Agencyname" ErrorMessage="*" ></asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Contactperson" width="200px" cssclass="txtboxcss" runat="server"></asp:TextBox>
