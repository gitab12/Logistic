<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="StatusUpdate.aspx.cs" Inherits="StatusUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    &nbsp;&nbsp;
   Enter Text :
    <asp:TextBox ID="txt_Search" Width="250px" runat="server"></asp:TextBox>
    &nbsp;&nbsp;
    <asp:Button ID="btn_Search" runat="server" Text="Search" OnClick="btn_Search_Click" Class="btn btn-primary" />
            </div>
    <br />
    <br />
        <asp:Panel ID="AarmsVehicleReport" runat="server"  BorderColor="#0000" BorderStyle="Solid" Font-Bold="false" Height ="270px" ScrollBars="Auto" Width="50%" GroupingText="" Style="margin-left:100px">
<div style="overflow:auto;vertical-align: top;">
    <asp:GridView ID="GridStatus" runat="server" Width="100px"
        ...
        <EmptyDataTemplate>
            <center>
                <asp:Label ID="lbl_Emptydata" runat="server" Text="No records found"></asp:Label></center>
        </EmptyDataTemplate>
    ...
    <asp:GridView ID="GridStatus2" runat="server" Width="100px"
        AutoGenerateColumns="False" BorderColor="#E0E0E0"
        CellPadding="4" ForeColor="#333333" GridLines="Both"
        OnRowEditing="GridStatus_RowEditing_edit" DataKeyNames="ActivityID"
        OnRowCancelingEdit="GridStatus_RowCancelingEdit_edit"
        OnRowUpdating="GridStatus_RowUpdating_edit"
        AllowSorting="True" >
        <RowStyle BackColor="#C2DDEB" ForeColor="#333333" />
        <Columns>
            <asp:TemplateField HeaderText="ID">
            ...
            <asp:TemplateField HeaderText="Action">
                <EditItemTemplate>
                    ...
                    <asp:DropDownList ID="ddlaction" runat="server" Width="120px">
                        ...
                        <asp:ListItem Value="Meeting Fixed">Meeting Fixed</asp:ListItem>
                        <asp:ListItem Value="Contact Later">Contact Later</asp:ListItem>
                        <asp:ListItem Value="Trip Plan Received">Trip Plan Received</asp:ListItem>
                    </asp:DropDownList>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblaction" runat="server" Text='<%# Bind("Action") %>'></asp:Label>
