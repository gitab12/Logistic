...
Partial Class Dealtodo
    ...
    Sub gridbind()
        Try
            ...
            ds = obj_class.BiZconnect_DealToDo()
    ...
    Protected Sub ButDeal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButDeal.Click
        ...
        For i As Integer = 0 To GridAssign.Rows.Count - 1
            ...
            If checkassign1.Checked Then
                ...
                resp = obj_class.Update_DealDone(replyid.Text, lblpostid.Text)
        ...
        Next
        If resp = 1 Then
            ClientScript.RegisterStartupScript(Me.GetType(), "clientscript", "alert ('Deal Done Successfully')", True)
        End If
        'Summary()
