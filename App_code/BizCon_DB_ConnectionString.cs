...
/// <summary>
/// Summary description for BizCon_DB_ConnectionString
/// </summary>
public class BizCon_DB_ConnectionString
{
    SqlConnection mcon;
    SqlCommand mcmd;
    static DataSet mds;
    ...
    string str = ConfigurationManager.ConnectionStrings["BizCon"].ConnectionString;
