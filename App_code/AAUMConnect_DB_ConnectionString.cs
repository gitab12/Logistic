...
/// <summary>
/// Summary description for AAUMConnect_DB_ConnectionString
/// </summary>
public class AAUMConnect_DB_ConnectionString
{
    SqlConnection mcon;
    SqlCommand mcmd;
    static DataSet mds;
    ...
    string str = ConfigurationManager.ConnectionStrings["AAUMCon"].ConnectionString;
