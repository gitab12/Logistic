...
using System.Data;
public partial class Delayed : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     if (Session["UserID"] != string.Empty && Convert.ToInt32(Session["UserID"].ToString()) > 0)
        ...
        if (!IsPostBack)
        {
            ...
            ds_cn = Obj_Class.Get_VehDelayed(Session["pjtno"].ToString ());
            grd_VehDelayed .DataSource = ds_cn;
            grd_VehDelayed.DataBind();
        }
        }
        else
        {
    ...
    {
        ds_CNote = Obj_Class.Bizconnect_ThermaxVehPlacementSearchonPjtNo(ddl_ProjectNo.SelectedValue.ToString(),"VehNotLoaded");
            grd_VehDelayed.DataSource = ds_CNote;
            grd_VehDelayed.DataBind();
    }
     ...
     protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ExportGrid(grd_VehDelayed, "Report.xls");
